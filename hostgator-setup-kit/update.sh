...
traefik) c_grn "✓ proxy externo (Traefik): o Caddy não é usado aqui — nada a recarregar" ;;
npm) c_grn "✓ proxy externo (Nginx Proxy Manager): o Caddy não é usado aqui — nada a recarregar" ;;
*)
